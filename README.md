...
The `deps.toml` file defines your project's dependencies. It uses TOML format with a `[defaults]` section and dependency definitions under `[dependencies.<name>]`.
