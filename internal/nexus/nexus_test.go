...
func TestUploadSingleFile(t *testing.T) {
	...
	// Test upload
	err = uploadFiles(testDir, "test-repo", "", cfg, opts)
	if err != nil {
...
func TestDownloadSingleFile(t *testing.T) {
	...
	// Test download
	success := downloadFolder("test-repo/test-folder", destDir, cfg, opts)
	if !success {
...
func TestURLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			_, err := listAssets(tt.repository, tt.src, cfg)
			if err != nil {
...
func TestUploadURLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err = uploadFiles(testDir, tt.repository, "", cfg, opts)
			if err != nil {
				t.Fatalf("Upload failed: %v", err)
			}
